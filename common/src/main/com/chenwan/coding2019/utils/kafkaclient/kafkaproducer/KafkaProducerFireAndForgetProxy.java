...
/**
 * @program: base Fire-and-forget（发送即忘记）
 * @description:
 * @author: cliffcw
 * @create: 2019-07-11 19:31
 */
public class KafkaProducerFireAndForgetProxy {

    private String kafkaBrokers;

    private Producer<String, String> producer;

    private static Map<String, KafkaProducerFireAndForgetProxy> instanceFactoryMap;

    private KafkaProducerFireAndForgetProxy(String kafkaBrokers) {
...
//        properties.put("partitioner.class", "自己写的类名");
    ...
    /**
     * @Description: KafkaProducerFireAndForgetProxy 实例
     * @Param:
     * @return:
     * @Author: cliffcw
     * @Date:
     */
    public static KafkaProducerFireAndForgetProxy getInstance(String kafkaBrokers) throws Exception {
        ...
        if (instanceFactoryMap == null || instanceFactoryMap.get(key) == null) {
            ...
            instanceFactoryMap = new HashMap<String, KafkaProducerFireAndForgetProxy>();

            KafkaProducerFireAndForgetProxy kafkaProducerFireAndForgetProxy = new KafkaProducerFireAndForgetProxy(kafkaBrokers);

            instanceFactoryMap.put(key, kafkaProducerFireAndForgetProxy);

            return kafkaProducerFireAndForgetProxy;
        } else {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaProducerFireAndForgetProxy.getInstance("localhost:9092,localhost:9093,localhost:9094").sendMsg(topic, routeKey, msg);
    }
}
